...
public class SoundtrackLoop implements ActionListener{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void assemble(){
    t = new Timer(34050, this);
    theme = new Score("StarCraftish");
  
    Part treble = new Part("Treble", JMC.SAWTOOTH, 1);
    treble.addPhrase(this.t_1_20());
    
    Part bass = new Part("Bass", JMC.SYNTH_BASS, 3);
    bass.addPhrase(this.b_1_20());
    
    Part harm1 = new Part("Harmony", JMC.SQUARE, 2);
    harm1.addPhrase(this.tH_1_20());
